...
<script lang="ts">
    ...
    let { path, href, thumbnailUrlInfo, title, summary, selectionControls }: Props = $props();
...
<Thumbnail {title} {thumbnailUrlInfo} {summary} {href} {deleting} {renaming} {cropping} {selectionControls} />
