        ...
        <g transform="scale(0.8)">
            <g transform="translate(-50,-50)">
                <g transform="rotate(336.033 50 50)">
                    ...
                    />
                    <path fill="#e4e4e4" d="M31.5,62.4L7.3,38.3c0,0,0,0,0,0C4,48.1,4.2,58.9,8.1,68.5h29.5L31.5,62.4z" />
                    <path fill="#e9e9e9" d="M45.7,71.9H11.5c0,0,0,0,0,0c4.5,9.3,12.4,16.7,21.9,20.8l20.8-20.8H45.7z" />
                    <path
                        fill="#ededed"
                        d="M62.4,68.5L38.3,92.6c0,0,0,0,0,0c9.8,3.4,20.6,3.1,30.2-0.8V62.4L62.4,68.5z"
                    />
                    <path fill="#f1f1f1" d="M71.9,45.7v8.6v34.2c0,0,0,0,0,0c9.3-4.5,16.7-12.4,20.8-21.9L71.9,45.7z" />
                    <path
                        fill="#f6f6f6"
