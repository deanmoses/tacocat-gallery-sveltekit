...
describe('fileFormats', () => {
    describe('getPathAfterServerProcessing', () => {
        ...
        it('converts HEIF to JPG', () => {
            expect(getMediaPath('/2024/01-01/photo.heif')).toBe('/2024/01-01/photo.jpg');
        });
        ...
        it('returns same path for JPG', () => {
            expect(getMediaPath('/2024/01-01/photo.jpg')).toBe('/2024/01-01/photo.jpg');
        });

        it('returns same path for PNG', () => {
            expect(getMediaPath('/2024/01-01/photo.png')).toBe('/2024/01-01/photo.png');
        });
    });
